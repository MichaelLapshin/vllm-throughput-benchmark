...
def run_scheduler_single_request(model, base_scheduler, num_output_tokens: int):
    scheduler = get_parameterized_scheduler(base_scheduler, model, num_output_tokens, ProfilerType.NCU_PROFILER)
...
if __name__ == "__main__":
    ...
    run_scheduler_single_request(args.model, scheduler, args.num_tokens)
